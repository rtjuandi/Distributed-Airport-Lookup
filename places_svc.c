...
{
	union {
		specified_city_state places_query_1_arg;
	} argument;
	char *result;
	...
	case PLACES_QUERY:
		_xdr_argument = (xdrproc_t) xdr_specified_city_state;
		_xdr_result = (xdrproc_t) xdr_places_ret;
		local = (char *(*)(char *, struct svc_req *)) places_query_1_svc;
		break;
